...
procedure BuildStateMachine(safe: boolean);
...
begin
  ...
  if completed < 0 then completed := 0;
  if completed > 1 then completed := 1;
...
begin
  ...
  case ActionScript[CurStep].atype of
    atGoToXY: begin
      ...
      if FHal.CBDebug.checked then begin
          FHal.EditActionDebug.text := 'GoToXY';
      end;
    ...
    atSwivelServo: begin
      ...
      if FHal.CBDebug.checked then begin
          FHal.EditActionDebug.text := 'Swivel';
      end;
    ...
    atRotateAndGo: begin
      ...
      if FHal.CBDebug.checked then begin
          FHal.EditActionDebug.text := 'RotateAndGo';
      end;
    ...
    atGoToWarehouse: begin
      ...
      if FHal.CBDebug.checked then begin
          FHal.EditActionDebug.text := 'GoToWarehouse';
      end;
    ...
    atFollowArc: begin
      ...
      if FHal.CBDebug.checked then begin
          FHal.EditActionDebug.text := 'FollowArc';
      end;
    ...
    atStop: begin
      ...
      if FHal.CBDebug.checked then begin
          FHal.EditActionDebug.text := 'Stop';
      end;
